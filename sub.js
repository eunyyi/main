...
//Toillette <-> Perfume
let Toillette = document.querySelector('.productToillette');
let Perfume = document.querySelector('.productPerfume');
let ToilletteBtn = document.querySelector('.sect2 a.Toillette');
let PerfumeBtn = document.querySelector('.sect2 a.Perfume');

ToilletteBtn.addEventListener('click', function(e) {
    e.preventDefault();
    Toillette.style.display = 'block';
    Perfume.style.display = 'none';
    total.classList.add('off');
})
PerfumeBtn.addEventListener('click', function(e) {
    e.preventDefault();
    Perfume.style.display = 'block';
    Toillette.style.display = 'none';
    total.classList.add('off');
})

// product hover 
let hover = document.querySelector('.hover');
let li = document.querySelector('ul.product li');
