...
// export const TopBannerImg = styled.img`
//     width: 30px;
//     position: absolute;
//     top: 50%;
//     right: 120px;
...
// export const TopMenuLogo = styled.a`
//     display: block;
//     width: 151px;
//     height: 59px;
//     background: url('images/logo/typeLogo_wh_2.png') no-repeat center / contain;
//     text-indent: -9999px;
// `;

// export const TopMenuA = styled.a`
//     color: #FFF;
// `;
